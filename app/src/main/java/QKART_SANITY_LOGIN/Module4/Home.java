...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            ExpectedConditions.elementToBeClickable(By.xpath("//h4[text()=' No products found ']"))));
            Thread.sleep(1000);
            return true;
        } catch (Exception e) {
        ...
        try {
            ...
            for (WebElement item : cartContents) {
                ...
                if (productName.contains(item.findElement(By.xpath(".//*[@class='MuiBox-root css-1gjj37g']/div[1]")).getText())) {
                    ...
                    // System.out.println(item.findElement(By.xpath(".//*[@class='MuiBox-root css-1gjj37g']/div[1]")).getText());
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            WebElement cartParent = driver.findElement(By.xpath("//div[@class='cart MuiBox-root css-0']"));
            ////div[@class='MuiBox-root css-zgtx0t']/div/div[1]/parent::*/parent::*/parent::*/parent::*
            List<WebElement> cartContents = cartParent.findElements(By.xpath("//div[@class='MuiBox-root css-1gjj37g']/div[1]"));
            // for(WebElement cart : cartContents)
            // {
            ...
            for (WebElement cartItem : cartContents) {
                ...
                //System.out.println(actualCartContents);
