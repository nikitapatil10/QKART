...
public class SearchResult {
    ...
    public String getTitleofResult() {
        ...
        WebElement gettitle = parentElement.findElement(By.xpath(".//p[@class='MuiTypography-root MuiTypography-body1 css-yg30e6']"));
        titleOfSearchResult = gettitle.getText();
    ...
    public Boolean openSizechart() {
        try {
            ...
            WebElement opensizechartlink = parentElement.findElement(By.xpath(".//button[text()='Size chart']"));
            opensizechartlink.click();
            Thread.sleep(2000);
            return true;
        } catch (Exception e) {
    ...
    public Boolean verifySizeChartExists() {
        ...
        try {
            ...
            {
                String text = sizechartlink.getText();
        ...
        try {
            ...
            for(int i = 0; i < expectedTableBody.size(); i++)
            {
                ...
                for(int j = 0; j < expectedTableRow.size(); j++)
                {
                    ...
                    WebElement actualTableBodyElement = driver.findElement(By.xpath("//table/tbody/tr[" + row + "]/td[" + column + "]"));//table/tbody/tr[i+1]/td[j+1]
                    String actualTableBodyData = actualTableBodyElement.getText();
                    //System.out.println(actualTableBodyData);
